...
| NVL-101.2 Install Docker Desktop; 🪟 enable WSL2 backend; 🍎 confirm VirtioFS | BOTH | 35 m | Whale icon steady |
...
| NVL-101.6 Install extensions: Dev Containers, Docker, 🪟 WSL, GitLens, Copilot | BOTH | 20 m | Extensions listed |
...
| NVL-102.3 Clone repository (🪟 **inside WSL2**, never `/mnt/c/`) | BOTH | 15 m |
...
| 15 | E18 | **EMI spike (verify, never assume)**, tax, invoicing, refunds | Provider capability differs from docs |
